...
- [ ] **Phase 38 — Shared Page-Shell Migration** — All operator screens (Home/Inbox/Audit/Settings/KB) rendered through `cl_page`; `cl_breadcrumb` wired on the deep KB-from-conversation path (4 plans, 2 waves)
