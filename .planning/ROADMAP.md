...
**Plans**: 3 plans (2 waves)
  - [x] 39-01-PLAN.md — Chat facade scoped queries (list_conversations/1 + count_conversations/1 + scope_status/2) [HOME-02, HOME-05] (wave 1)
  - [x] 39-02-PLAN.md — InboxLive resolved filter: handle_params/3 + fail-closed normalize_status/1 + filter-aware PubSub + applied-filter row [HOME-02] (wave 2)
  - [x] 39-03-PLAN.md — HomeLive two-tier restructure: hero + 3-up band + zero-state; scoped/throttled fail-closed counts [HOME-01..05] (wave 2)
**UI hint**: yes
