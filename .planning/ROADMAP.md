...
**Plans**: 3 plans (2 waves)
  - [ ] 40-01-PLAN.md â conversation_live.ex hex→token + footer rebuilt with cl_button/.cl-textarea (DRIFT-01, DRIFT-02, wave 1)
  - [ ] 40-02-PLAN.md â search_modal_component.ex rgba→token snap + cl_chip source/trust badges (DRIFT-01, wave 1)
...
| 40. Drift Remediation + Brand-Token Gate Hardening | vM016 | 0/3 | Not started | â |
