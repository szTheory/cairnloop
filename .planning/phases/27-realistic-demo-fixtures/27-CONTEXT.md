...
- **D-07:** *[informational — scope-fence; no implementation owed in this phase]* Phase 27 does NOT upgrade the embedder mock to varied deterministic vectors. That is a Phase 31 (smoke-test stability) or vM015 concern. (Cross-referenced in `<deferred>` below.)
