...
dependency_graph:
  requires: []
  provides:
    - "SupportOS.ContextProvider"
    - "SupportOS.DefaultContextProvider"
  affects:
...
key_files:
  created:
    - "lib/support_os/default_context_provider.ex"
    - "test/support_os/context_provider_test.exs"
  modified:
    - "lib/support_os/context_provider.ex"
...
**One-Liner:** Implemented the robust `SupportOS.ContextProvider` behaviour using tagged tuples to fetch identity-bound host data without UI crashes.
